...
namespace jpgd
{
	...
	public:
		...
		int decode(const void** pScan_line, uint* pScan_line_len, int r, int left, int top, int right, int bottom);
	...
	private:
		...
		void load_next_row();
		void decode_next_row(int r, int left, int top, int right, int bottom);
		...
		int decode_next_mcu_row(int r, int left, int top, int right, int bottom);
